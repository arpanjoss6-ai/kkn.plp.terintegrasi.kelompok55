...
const cards = [
  {
    ...
    icon: MapPin,
    title: "Alamat Posko",
    lines: [siteConfig.address, `${siteConfig.village}, ${siteConfig.kabupaten}`],
  ...
  },
  {
    ...
    icon: MessageCircle,
    title: "WhatsApp",
    lines: [siteConfig.whatsappDisplay, "Senin — Sabtu, 08.00–20.00 WIB"],
  ...
  },
  {
    ...
    icon: Mail,
    title: "Email",
    lines: [siteConfig.email, "Balasan maks. 1x24 jam"],
    testid: "contact-email",
  },
];

const socials = [
  { icon: Instagram, url: siteConfig.socials.instagram, label: "Instagram", testid: "contact-social-instagram" },
  { icon: Youtube, url: siteConfig.socials.youtube, label: "YouTube", testid: "contact-social-youtube" },
  { icon: Music2, url: siteConfig.socials.tiktok, label: "TikTok", testid: "contact-social-tiktok" },
  { icon: Facebook, url: siteConfig.socials.facebook, label: "Facebook", testid: "contact-social-facebook" },
];
